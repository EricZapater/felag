...
export default function ExploreDestinationsView() {
  ...
  const itemsToDisplay = recommendations;
          ...
          {filteredItems.length === 0 && !isLoading ? (
            ...
            >
              ...
              <Typography variant="body2" sx={{ color: '#786C65', maxWidth: 500, mx: 'auto' }}>
                {searchTerm.trim()
                  ? `No s'han trobat viatges o recomanacions per a "${searchTerm}".`
                  : 'Encara no hi ha viatges o recomanacions registrades a la comunitat. Crea el teu primer viatge o afegeix un consell per començar!'}
              </Typography>
            </Box>
          ) : (
