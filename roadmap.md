...
- [ ] Destination pages (cities and countries linked to geographic DB)
...
- [ ] Helpful votes ("Useful 👍") & discussion comments
- [ ] Content moderation & community reporting
- [ ] Proximity and origin filtering

## Real-Time Travel Moments
- [ ] Arrival question (Opt-in): When a trip starts at a destination, prompt the user: *"Are you in Tokyo? Would you like to share photos in real time with fellow FELAGIS who are here right now?"*
- [ ] Ephemeral Destination Feed: Shared image stream for users present in the same destination with overlapping dates (stored in Cloudflare R2).
